...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const Trips = [
      {id: 1, expenses : [{expenseId : 1, nit : "23423342",category: {id: 1, name: "Alimentación"}, date: "2017-04-07T20:39:56.121224Z", description : "", value : 10000, photoURL:"", approved: null}], budget : 500000, startDate : "2017-04-07T20:39:56.121224Z", endDate : "2017-04-07T20:39:56.121224Z", destiny : "Cali", description : "", status : {tripStatusId : 1, name : "Estado 1"}, employee: {id : 1, firstName : "Victor", lastName : "Suarez", email : "victor.suarez@empresauno.com", organization : {id: 1, name: "Empresa 1"}}},
    ...
    return {Trips, expenses, TripStatuses, Users};
  }
}